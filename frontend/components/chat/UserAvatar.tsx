...
export function UserAvatar({ user }: UserAvatarProps) {
    const { isAuthenticated, isTemporary, logout } = useAuth()
        ...
        <div className="space-y-3">
            ...
            <div className="border-t pt-3 space-y-2">
                ...
                <div className="text-sm">
                    ...
                    <span className="font-mono text-gray-900">{user.roomId || 'unknown'}</span>
                </div>
            </div>
            ...
            <div className="border-t pt-3">
                {isTemporary ? (
                    ...
                    <button
                        className="w-full text-sm text-red-500 hover:text-red-700 py-2 px-3 rounded border border-red-200 hover:bg-red-50 transition-colors"
                        onClick={() => logout()}
                    >
                        ログアウト
                    </button>
