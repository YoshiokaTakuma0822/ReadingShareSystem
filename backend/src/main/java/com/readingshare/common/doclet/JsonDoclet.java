...
public class JsonDoclet implements Doclet {
    ...
    private Map<String, Object> processClass(TypeElement clazz) {
        ...
        java.util.Set<String> autoMethodNames = new java.util.HashSet<>();
        ...
        for (ExecutableElement method : ElementFilter.methodsIn(clazz.getEnclosedElements())) {
            ...
            if (isAutoGen) {
                methodMap.put("description", "Java Compiler が自動的に追加したメソッド。"); // auto-generated by javac
                @SuppressWarnings("unchecked")
                List<Map<String, Object>> params = (List<Map<String, Object>>) methodMap.get("params");
